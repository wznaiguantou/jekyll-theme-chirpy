...
```java
    private ConfigurableEnvironment prepareEnvironment(
        ...
        // 环境已经配置的差不多了，这里其实有点疑惑的，对environment.getPropertySources() 取出来放到了一个
...
<img src="../../assets/img/spring/environment.png" alt="Environment Class Diagram" style="zoom:60%;" />
...
<img src="../../assets/img/spring/SpringBoot 事件顺序图.jpg" alt="SpringBoot Eevent" style="zoom:80%;" />

## 3. 总结

本次的源码主要解析了下SpringBootApplication实例化、初始化的过程以及部分run()方法中执行的内容。

我们以一张时序图来总结下我们今天学到的内容

![SpringBootAppliaction StartUp](../../assets/img/spring/SpringBoot 启动过程-1.jpg)
